...
def callback(joint_values):
	...
	rospy.loginfo("this is my joint_values.name")
	...
	while True:
            if link_name not in robot.child_map:
                break
	    if len(robot.child_map[link_name]) != 1:
                break
	...
	rospy.loginfo("this is my joints_names")
	...
	for i in range(len(joints)) :
		...
		msg = message_from_transform(T,'world',link_names[i])
...
if __name__ == '__main__':
	listener()
#rosrun asgn2 forward_kinematics_test1.py
