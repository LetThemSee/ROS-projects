...
#######################################################################################################
		...
		req.ik_request.robot_state.joint_state.name = ['elbow_joint', 'shoulder_lift_joint', 'shoulder_pan_joint', 'wrist_1_joint', 									'wrist_2_joint', 'wrist_3_joint']
		req.ik_request.robot_state.joint_state.position = numpy.zeros(6)
		req.ik_request.robot_state.joint_state.velocity = numpy.zeros(6)
		req.ik_request.robot_state.joint_state.effort = numpy.zeros(6)
	...
	# the joints of the KUKA arm, ordered from proximal to distal. 
		...
		req.robot_state.joint_state.name =  ['elbow_joint', 'shoulder_lift_joint', 'shoulder_pan_joint', 'wrist_1_joint', 							     'wrist_2_joint', 'wrist_3_joint']
		req.robot_state.joint_state.position = q
		req.robot_state.joint_state.velocity = numpy.zeros(6)
		req.robot_state.joint_state.effort = numpy.zeros(6)
